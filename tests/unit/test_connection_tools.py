...
from oci_kafka_mcp.kafka.connection import CircuitBreaker, CircuitState
...
class TestAdminClientReconfigure:
    ...
    @patch("oci_kafka_mcp.kafka.admin_client.AdminClient")
...
class TestConnectionTools:
    ...
    def test_configure_persist_writes_file(self, tmp_path: pytest.FixtureRequest) -> None:
        ...
        from oci_kafka_mcp.tools import connection as conn_module
        from oci_kafka_mcp.tools.connection import register_connection_tools
